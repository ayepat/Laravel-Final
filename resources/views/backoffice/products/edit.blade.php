...
<body class="d-flex flex-column min-vh-100 bg-light">
    ...
    <main class="container --bs-primary-bg-subtle mt-5 mb-5">
        ...
        <form method="POST" action="/backoffice/products/{{ $product->id }}">
            ...
            <div class="mb-3">
                <label for="formFile" class="form-label">IMAGEN - guarda</label>
                <input class="form-control" type="file" id="formFile" value="{{ $product->image_url }}" required>
            </div>
                ...
                <form>
                    @foreach ($tags as $tag)
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="checkbox" id="inlineCheckbox{{ $tag->id }}" value="{{ $tag->value }}">
